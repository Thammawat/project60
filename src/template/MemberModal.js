        ...
        {this.props.MemberModalTopic === "เพิ่มสมาชิกใหม่"
          ...
          : <form onSubmit={null}>
              ...
              <div className="MemberModalInside animated fadeInUp">
                ...
                <div className="MemberModalBody">
                  <div className="HalfModal">
                    <input type="text" className="MemberModalInput" placeholder="ชื่อ" value={this.state.tempMember.firstname} onChange={this.changeFirstname} disabled/>
                  </div>
                  <div style={{width:'5%',display:'inline-block'}} />
                  <div className="HalfModal">
                    <input type="text" className="MemberModalInput" placeholder="นามสกุล" value={this.state.tempMember.lastname} onChange={this.changeLastname} disabled/>
                  </div>
                  <div className="PermissionTopic">
                    <span>สถานะของสมาชิก :</span>
                  </div>
                  ...
                  <div className="PermissionList">
                    <input type="radio" value="admin" checked={this.state.tempMember.status === 'assistant'} onChange={this.changeStatus} className="PermissionChoice" />
                    <span> ผู้ช่วยผู้ดูแลระบบ</span>
                  </div>
                  <div className="PermissionList">
                    <input type="radio" value="member" checked={this.state.tempMember.status === 'member'} onChange={this.changeStatus} className="PermissionChoice" />
